...
if (hole_x >= brick_x and hole_y >= brick_y) or (hole_y >= brick_x and hole_x >= brick_y):
    print('Да, пройдет')
elif (hole_x >= brick_x and hole_y >= brick_z) or (hole_y >= brick_x and hole_x >= brick_z):
    print('Да, пройдет')
elif (hole_x >= brick_y and hole_y >= brick_z) or (hole_y >= brick_y and hole_x >= brick_z):
    print('Да, пройдет')
else:
    print('Нет, не пройдет')
